...
const ManageProduct = () => {
  const { price, setimage, handleDataDelete, quntity, allProductDataDB, setquntity, preview, setprice, setPreview, ProductDec, setProductDec, ProductTitle, setProductTitle, handleProductDataUpload } = useContext(DashboardContext);
                  ...
                  <div className="overflow-y-auto  overflow-x-hidden  max-h-[400px] w-full">
                    ...
                    {arry.map((item, i) => (
                        ...
                        >
                          ...
                          <div className="h-full -mt-5 ml-10   ">

                          <button className="ml-10 text-yellow-400 text-2xl hover:scale-110 transition">
                          ...
                          <h1  className="text-2xl font-semibold text-nowrap">Rs {item.price}</h1>
                          </div>
                        </motion.div>
                    ))}
                    </AnimatePresence>
